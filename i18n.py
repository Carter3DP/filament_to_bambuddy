...
EN = {
    ...
    "mapping": {
        ...
        "remaining_weight": "Remaining filament (g)",
        "remaining_weight_placeholder": "Remaining filament in grams",
        "invalid_remaining_weight": "Enter a valid remaining filament weight in grams.",
        "scan": "📷 Scan barcode",
        "save": "Save barcode",
        "save_changes": "Save changes",
        "saved": "Barcode saved for spool #{spool_id}",
        "changes_saved": "Changes saved for spool #{spool_id}",
    ...
    "assignment": {
        ...
        "both_description": "Scan both the reusable spool barcode and a printer-slot barcode to assign without choosing from a list.",
        "mode": "Barcode mode",
        "spool_mode": "Spool barcode",
        "printer_mode": "Printer barcode",
        "both_mode": "Spool + Printer barcode",
        "printer": "Printer",
        "slot": "Filament slot",
        ...
        "scan": "📷 Scan barcode",
        "scan_printer": "📷 Scan printer barcode",
        "assign": "Assign spool",
        ...
        "both_missing_fields": "Scan both a reusable spool barcode and a printer-slot barcode.",
        "spool_not_mapped": "This barcode is not linked to a tracked spool",
...
FR = {
    ...
    "form": {
        ...
        "filament_cost": "Coût du filament",
        "cost_per_kg": "Coût /kg",
        "note": "Note",
...
PT_BR = {
    ...
    "form": {
        ...
        "filament_cost": "Custo do filamento",
...
TR = {
    ...
    "form": {
        ...
        "filament_cost": "Filament maliyeti",
